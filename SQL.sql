...
CREATE TABLE SANPHAM (
    ...
    FOREIGN KEY (MA_LOAI) REFERENCES LOAISANPHAM(MA_LOAI)  -- Khóa ngoại tham chiếu đến bảng LOAISANPHAM
);
...
-- thêm dữ liệu vào bảng HD_XUAT_BAOHANH
INSERT INTO HD_XUAT_BAOHANH (MAHD_XUAT, SDT_KH, MA_NV, TONGBILL_XUAT, PHUONGTHUCGIAODICH, NGAYXUAT)
VALUES
('HDX001', '0901234567', 'NV001', 35000000, N'Tiền mặt', '2024-10-12'),
('HDX002', '0934567890', 'NV002', 35000000, N'Tiền mặt', '2024-10-10');
