    ...
    public partial class User_HoaDon : UserControl
    {
        ...
        private void btn_TaoHD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var selectedSDTKH = khachHangs.FirstOrDefault(t => t.SDTKH == cb_SDTKH.Text);
                if (selectedSDTKH != null)
                {
                    //hoaDon.SDT_KH
                    hoaDon.SDT_KH = selectedSDTKH.SDTKH;
                }
                else
                {
        ...
        {
            var khachHang = khachHangs.FirstOrDefault(t => t.SDTKH == cb_SDTKH.Text);
        ...
        private void btn_XoaHD_Click(object sender, EventArgs e)
        {
            ...
            if (sanPhamToDelete != null)
            {
                ...
                sanPham1.SoLuong += sanPhamToDelete.SoLuong;
                LoadSanPham(sanPhams);
        ...
        private void btn_SuaHD_Click(object sender, EventArgs e)
        {
            ...
            if (sl == 0)
            {
                sanPham1.SoLuong += sanPhamToUpdate.SoLuong; 
            ...
            else
            {
                ...
                int chenhLech = sl - sanPhamToUpdate.SoLuong;

                if (sanPham1.SoLuong+sanPhamToUpdate.SoLuong < sl)
                {
                    MessageBox.Show("Số lượng trong kho không đủ để sửa đổi!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                sanPham1.SoLuong -= chenhLech; 
        ...
        private void btn_ThemHD_Click(object sender, EventArgs e)
        {
            ...
            SanPham sanPham1 = sanPhams.FirstOrDefault(t => t.TenSP == cb_TenHang.Text);
            if (sanPham1 == null)
            {
            ...
            SanPham sanPham = sp_dat.FirstOrDefault(sp => sp.TenSP == cb_TenHang.Text);
            if (sanPham != null)
            {
